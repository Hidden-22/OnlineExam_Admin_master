...
export class AddquestionComponent implements OnInit {
  ...
  constructor(private subject_ser:SubjectService,private tag_ser:TagService,private AddquestionService:AddquestionService) { }
  diff_select()
  {
  ...
  onclickAdd()
  {
    ...
    this.AddquestionService.addQuestion(new questions_class(this.subject_id,this.tag_id,this.diff_id,this.Question,this.Option1,this.Option2,this.Option3,this.Option4,this.Answer,this.count))
    .subscribe((data:any)=>{
      console.log(data);
    });
